...
這個 skill 的所有演算法知識來自 **[darkseoking](https://www.threads.net/@darkseoking)** 的公開研究。他花了大量時間閱讀 Meta 演算法專利和 Google 反壟斷訴訟文件，把晦澀的專利語言拆解成可理解的機制分析，再用自己從 6K 到 20K 追蹤的實戰經驗逐一驗證。這 5 篇貼文串涵蓋 26 個機制、引用超過 15 個專利，是目前中文圈對 Threads 演算法最深入的公開研究。

本 skill 做的事只是把他的研究重新萃取成 AI 可操作的框架——知識的原創者是他，致上最大的感謝。
